            ...
            <div class="w-full flex flex-col justify-center items-center">
                <table class="w-full p-2 m-2 lg:w-5/6 flex flex-col justify-around items-center border border-blue-500">
                    ...
                    <tr class="flex w-full justify-around items-center border-blue-500 border bg-white p-1 m-1 text-blue-500 font-bold">
                        ...
                        <td class=" h-full">
                            <form action="{{route('choosedate')}}" method="post">
                            @csrf
                                <input type="hidden" name="id" value="{{$user->id}}">
                                <button class="w-10 h-10 rounded-full font-bold lg:text-green-500 bg-yellow-500 lg:bg-white hover:bg-green-500 text-white hover:text-white text-xl" type="submit">&#10003</button>
                            </form>
                        </td>
